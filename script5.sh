...
echo ""
read -p "1. Name one open-source tool you use every day: " GitHub
read -p "2. In one word, what does 'freedom' mean to you? " Universal
read -p "3. Name one thing you would build and share freely: " Website
DATE=$(date '+%d %B %Y')
